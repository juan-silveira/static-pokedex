...
function autocomplete(inp, arr) {
    ...
    inp.addEventListener("input", function (e) {
        ...
        for (i = 0; i < arr.length; i++) {
            /*check if it have 12 results already, if it does, stop generate new elements*/
            if(x > 11){
                return;
            }
...
/*initiate the autocomplete function on the "search" element, and pass along the pokemons array as possible autocomplete values:*/
